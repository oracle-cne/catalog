...
| `initChownData.image.repository`          | init-chown-data container image repository    | `os/oraclelinux`                                               |
...
| `sidecar.image.repository`                | Sidecar image repository                      | `olcne/k8s-sidecar`                          |
