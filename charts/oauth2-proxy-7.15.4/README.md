...
```console
$ ocne application install --name oauth2-proxy --release oauth2-proxy
```
...
```console
$ ocne application install --name oauth2-proxy --release my-release
```
...
| `envFrom`                                            | List of sources to pull environment variables from                                                                                                                                                                                                 | `[]`                                                                                                 |
...
```console
$ ocne application install --name oauth2-proxy --release oauth2-proxy --values - <<EOF
image:
  tag:v0.0.2
resources:
  limits:
...
```console
$ ocne application install --name oauth2-proxy --release oauth2-proxy --values values.yaml
```
