...
```console
ocne application install --release my-release --name grafana --namespace grafana
```
...
```console
ocne application uninstall --release my-release --namespace grafana
```
...
| `image.repository`                        | Image repository                              | `olcne/grafana`                                       |
...
| `initChownData.image.registry`            | init-chown-data container image registry      | `os`                                               |
| `initChownData.image.repository`          | init-chown-data container image repository    | `oraclelinux`                                               |
| `initChownData.image.tag`                 | init-chown-data container image tag           | `8-slim`                                                |
...
| `sidecar.image.registry`                  | Sidecar image registry                        | `olcne`                          |
| `sidecar.image.repository`                | Sidecar image repository                      | `k8s-sidecar`                          |
| `sidecar.image.tag`                       | Sidecar image tag                             | `v1.30.7`                                                |
